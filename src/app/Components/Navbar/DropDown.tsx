...
const DropDown = ({ indexProp, secondChildClass, mega, num, name, data, childDivClass, childDivChildClass, val, setVal, hideDropDown} : any) => {
    ...
    const [showMoreDetail, setShowMoreDetail] = useState(100);
    const [showMoreDetail2, setShowMoreDetail2] = useState(100)
    const [showMoreDetail3, setShowMoreDetail3] = useState(100)
